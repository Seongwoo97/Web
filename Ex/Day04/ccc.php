<?php
    ...
    // [저장할 데이터들 : $name, $title, $message, $dst_name(파일 경로), $now]
    ...
    $sql= "INSERT INTO board(name, title, message, file, date) VALUES('$name', '$title', '$message', '$dst_name', '$now')";
